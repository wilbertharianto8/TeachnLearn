                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Number of Student
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <?php
                                    ...
                                    if($resultCheck > 0){
                                        ...
                                        ?>
                                        <br><h3 class="small font-weight-bold"><?php echo $courseName?><span
                                            class="float-right">!00%</span></h3>
                                        <div class="progress">
