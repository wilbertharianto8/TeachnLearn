            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">My Course</h1>
                        <a button type="button" href="addCourse.php">Add course</a>
                    </div>
                    ...
                    <?php
                        $sql = "SELECT * FROM course WHERE teacherKeyID = '$teacherID'";
                        $result = mysqli_query($link,$sql);
                        $resultCheck = mysqli_num_rows($result);
                        ...
                        if($resultCheck > 0){
                            ...
                            while ($row = mysqli_fetch_assoc($result)){
                                ...
                                $noStudent = $row['seat'];
                                $duration = $row['hour'];
                                $picture = $row['coursePng'];
                                $image = "img/".$picture;
                                $shortDescript = $row['short_descript'];
                    ?>            
                                <tr>
                                        <td><?php echo $num; ?></td>
                                        <td><img src='<?php echo $image ?>' class="preview" alt="course.png"></td>
                                        <td><?php echo $courseName; ?></td>
                                        <td><?php echo $courseType; ?></td>
                                        <td class="midNum"><?php echo $fee; ?></td>
                                        <td class="midNum"><?php echo $noStudent; ?></td>
                                        <td class="midNum"><?php echo $duration; ?></td>
                                        <td><?php echo $shortDescript; ?></td>
                                        </tr>
                    <?php
                            }
