  ...
  <main id="main">
    ...
    <section id="course-details" class="course-details">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
            ...
            <img src="assets/img/course-details-4.jpg" class="img-fluid" alt="">
            <h3>Phyton Basic Class</h3>
            <p>
    ...
    <section>
        <div class ="row">
            ...
            <button onclick="document.location = 'feedback.php'">End course</button>
            </div>
        </div>
    </section>
